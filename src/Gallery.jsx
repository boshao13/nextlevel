...
// ─── Assets ─────────────────────────────────────────────────────────────────
const videoPairs    = [
  { webm: '/videos/gallery1.webm', mp4: '/videos/gallery1.mp4', poster: '/videos/posters/gallery1.jpg', label: 'Gravel' },
  { webm: '/videos/gallery2.webm', mp4: '/videos/gallery2.mp4', poster: '/videos/posters/gallery2.jpg', label: 'Onyx' },
  { webm: '/videos/gallery3.webm', mp4: '/videos/gallery3.mp4', poster: '/videos/posters/gallery3.jpg', label: 'Outback' },
];
...
const VideoCard = styled.div`
  ...
  &:hover {
    ...
    box-shadow: var(--shadow-dk-lg), var(--glow-resin);
  }
    ...
    <Section id="gallery">
      <Inner>
        ...
        <div ref={contentRef} className={`reveal ${contentVisible ? 'visible' : ''}`}>
          ...
          >
            <InstagramIcon viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
